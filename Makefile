...
CXXFLAGS = -g -O2  -march=armv7-a -mfpu=neon-vfpv4 -mfloat-abi=hard -funsafe-math-optimizations
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lSDL_sound -lasound -lm -ldl -lpthread -L/usr/lib/arm-linux-gnueabihf -lSDL -lpng -lz -lpcap -lSDL_net -lX11
LTLIBOBJS = 
MAKEINFO = makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
VERSION = 0.74
WINDRES = :
abs_builddir = /home/pi/src/dosbox-syncgw
abs_srcdir = /home/pi/src/dosbox-syncgw
abs_top_builddir = /home/pi/src/dosbox-syncgw
abs_top_srcdir = /home/pi/src/dosbox-syncgw
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/pi/src/dosbox-syncgw/install-sh
